...
```bash
make release-check PACKAGE_VERSION=0.8.0
```
...
Use a SemVer value such as `0.8.0` for stable releases. Beta input may include a suffix such as `0.9.0-beta.1`; if the
