...
```bash
make release-check PACKAGE_VERSION=1.1.1
```
...
Use a SemVer value such as `1.1.1` for stable releases. Beta input may include a suffix such as `1.1.1-beta.1`; if the
